...
class Menu:
    ...
    def secondary_menu_event_handler(self, game):
        ...
        if game.death_count >= 1:
            ...
            text_rect = game.draws.text_rect(x_text_pos - 25, y_text_pos + 30, game)
            game.screen.blit(text, text_rect)

            text2 = game.draws.generate_text(f"higher rating: {game.maior_score}", 18)
            text_rect2 = game.draws.text_rect(x_text_pos - 10, y_text_pos - 170, game)
